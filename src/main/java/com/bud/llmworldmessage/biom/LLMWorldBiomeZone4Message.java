...
public class LLMWorldBiomeZone4Message implements ILLMWorldInfoMessage {
    ...
    public String getMessageForContext(BudWorldContext context, String additionalInfo) {
        ...
        if (biomeName.contains("charred")) {
            ...
            return "Hot and fiery with flowing lava. Big gabs are everywhere. Watch out for undead monsters.";
            ...
            return "A wonderful tropical jungle with lush vegetation and diverse wildlife. Glimming crystals bringing light in the underground jungle. But be careful of dinosaurs roaming around.";
        } else if (biomeName.contains("cave") || biomeName.contains("tunnels")) {
            return "The deep caves and tunnels are filled with iron ore and adamantite ore. But be careful of monsters and cave spiders. Also watch out for ice lakes and frozen traps.";
        } else {
