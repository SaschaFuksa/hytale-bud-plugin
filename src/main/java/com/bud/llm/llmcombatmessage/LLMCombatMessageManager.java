...
public class LLMCombatMessageManager {
    ...
    private static HashMap<List<String>, String> setupEntityCategoryMap() {
        ...
        entityCategoryMap.put(List.of("void", "hedera"),
                "Voidspawn");
        entityCategoryMap.put(
                List.of("antelope", "armadillo", "bison", "boar", "bunny", "camel", "chick", "cow", "calf", "doe",
                        "stag", "goat", "kid", "horse", "foal", "bull", "mosshorn", "mouflon", "pig", "piglet",
                        "rabbit", "ram",
        ...
        entityCategoryMap.put(
                ...
                "Avian");
        entityCategoryMap.put(
                List.of("cactee", "frog", "gecko", "larva", "meerkat", "molerat", "mouse", "rat", "scorpion", "slug",
                        "snail", "cobra", "snake", "rattlesnake", "spider", "squirrel"),
                "Critter");
        entityCategoryMap.put(
                List.of("crocodile", "fen stalker", "lizard", "raptor", "rex", "snapdragon", "toad", "tortoise",
                        "trillodon"),
                "Reptile");
